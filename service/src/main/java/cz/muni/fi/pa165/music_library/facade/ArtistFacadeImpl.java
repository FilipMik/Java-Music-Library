...
public class ArtistFacadeImpl implements ArtistFacade {
    ...
    public List<ArtistDto> getAllArtists() {
        ...
        return (artists == null) ? null : mapper.mapTo(artists,ArtistDto.class);
    }
    ...
    public void createArtist(ArtistDto artist) {
        ...
        Artist artistCreate = mapper.mapTo(artist,Artist.class);
    ...
    public void updateArtist(ArtistDto artist) {
        ...
        Artist artistUpdate = mapper.mapTo(artist,Artist.class);
